...
public class SqlUserQuery {
    ...
    private static final String FIND_ALL_SORT_QUERY = "select user from User user order by";

    public static String findAllSorted(Set<ColumnUserName> orderBy, SortType sortType) {
