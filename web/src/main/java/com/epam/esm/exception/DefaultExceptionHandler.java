...
public class DefaultExceptionHandler {
    ...
    private final String NOT_FOUND = "Not found path to this resource";
    ...
    public ResponseEntity<ErrorMessage> handleNoSuchMessageException() {
        return new ResponseEntity<>(new ErrorMessage(400, INCORRECT_SEARCH), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(QueryException.class)
    public ResponseEntity<ErrorMessage> handleHibernateException() {
        return new ResponseEntity<>(new ErrorMessage(400, INCORRECT_SEARCH), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorMessage> handleMissingServletRequestException() {
        return new ResponseEntity<>(new ErrorMessage(400, INCORRECT_SEARCH), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<ErrorMessage> handleIncorrectSyntaxException() {
        return new ResponseEntity<>(new ErrorMessage(400, INCORRECT_SYNTAX), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(PSQLException.class)
    public ResponseEntity<ErrorMessage> handlePSQLException() {
        return new ResponseEntity<>(new ErrorMessage(400, INCORRECT_SEARCH), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(NoHandlerFoundException.class)
    public ResponseEntity<ErrorMessage> handleNotFoundPathException() {
        return new ResponseEntity<>(new ErrorMessage(404, NOT_FOUND), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    public ResponseEntity<ErrorMessage> handleNotSupportException() {
